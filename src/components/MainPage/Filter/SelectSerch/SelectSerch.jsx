...
import { sortByAgeUp, sortByAgeDown, sortByNameDown} from '../../../../redux/user-reducer'
import { useDispatch } from 'react-redux'
import { sortByNameUp } from './../../../../redux/user-reducer';
   ...
   const dispatch =useDispatch()
    ...
    return (
        <select name="select" className={style.sort} onChange={(e)=>setValue(e.target.value)}>
            ...
            <option value="nameCBA" selected>Name c</option>
